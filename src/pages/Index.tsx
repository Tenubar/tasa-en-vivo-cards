  ...
  const Index: React.FC = () => {
    ...
    // Effect to update Bolivar value when exchange rate or dollar value changes
    useEffect(() => {
      if (exchangeRate !== null && dollarValue) {
    ...
    const handleBolivarChange = (value: string) => {
      ...
      if (value && exchangeRate) {
        const newDollarValue = (Number.parseFloat(value) / exchangeRate).toFixed(2)
